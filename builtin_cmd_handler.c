...
/**
 * check_builtin - Checks if parsed cmd in built-in
 * @cmd: Parsed cmd to be check
...
/**
 * handle_builtin - Handles predefined built in cmds
...
/**
 * exit_bul - Exit Status for built-in cmds
 * @cmd: Array of parsed cmd strings
